...
- [ ] Interface declared by the consumer (in `internal/app/`), small, one role
- [ ] Exported identifiers documented for `go doc`
- [ ] `make check` green — gofmt, vet, domain-check, tests, -race
