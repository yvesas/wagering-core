...
```go
// Campos não exportados: não existe caminho que produza um valor inválido.
// Construtor valida, método explícito faz a transição.
...
func NewModelName(field1 string, field2 Money) (ModelName, error)
```
